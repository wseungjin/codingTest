...
def main():
    print(solution("line", ["-s STRINGS", "-n NUMBERS", "-e NULL"],
                   ["line -n 100 102 -s hi -e", "line -n id pwd -n 100"]))
    print(solution("line", ["-s STRINGS", "-n NUMBERS", "-e NULL"],
                   ["line -n 100 102 -s hi -e -e", "line -n id pwd -n 100"]))
    print(solution("trip", 	["-days NUMBERS",
                             "-dest STRING"], ["trip -days 15 10 -dest Seoul Paris", "trip -days 10 -dest Seoul"]))
